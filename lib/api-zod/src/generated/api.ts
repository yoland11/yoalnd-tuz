...
export const ListProductsResponseItem = zod.object({
  ...
  stock: zod.number(),
  ownStock: zod.number().optional(),
  isRental: zod.boolean().optional(),
  isAsset: zod.boolean().optional(),
  pricePerDay: zod.number().optional(),
  sharedStockProductId: zod.number().nullish().optional(),
  sharedStockProductName: zod.string().nullish().optional(),
  sharedStockLinkedProducts: zod.array(zod.object({ id: zod.number(), name: zod.string() })).optional(),
  minStock: zod.number().optional(),
  barcode: zod.string().nullish(),
  categoryId: zod.number().nullish(),
  subcategoryId: zod.number().nullish(),
  categoryName: zod.string().nullish().optional(),
  subcategoryName: zod.string().nullish().optional(),
  ...
  showInBouquetBuilder: zod.boolean().optional(),
  bouquetElementType: zod.enum(["FLOWER", "GREENERY", "FILLER", "WRAPPING", "RIBBON", "ACCESSORY", "TEMPLATE", "EXCLUDED"]).optional(),
  previewCutoutUrl: zod.string().nullish().optional(),
  readyMadePreviewUrl: zod.string().nullish().optional(),
  previewAssetUrl: zod.string().nullish().optional(),
  previewColor: zod.string().nullish().optional(),
  previewScale: zod.number().nullish().optional(),
  previewRotation: zod.number().nullish().optional(),
  previewLayer: zod.number().int().nullish().optional(),
  previewPosition: zod.object({ x: zod.number().optional(), y: zod.number().optional(), anchor: zod.string().optional() }).nullish().optional(),
  accessoryType: zod.string().nullish().optional(),
  maximumQuantityPerBouquet: zod.number().int().nullish().optional(),
  bouquetRecipe: zod.array(zod.object({}).passthrough()).optional(),
  isReadyMadeBouquet: zod.boolean().optional(),
...
export const CreateProductBody = zod.object({
  ...
  pricePerDay: zod.number().optional(),
  sharedStockProductId: zod.number().nullish().optional(),
  sharedStockLinkedProductIds: zod.array(zod.number()).optional(),
  minStock: zod.number().optional(),
  barcode: zod.string().optional(),
  categoryId: zod.number().nullish().optional(),
  assetCategoryId: zod.number().nullish().optional(),
  subcategoryId: zod.number().nullish().optional(),
  subcategoryIds: zod.array(zod.number()).optional(),
  ...
  availableInBouquetDesigner: zod.boolean().optional(),
  showInBouquetBuilder: zod.boolean().optional(),
  bouquetElementType: zod.string().nullish().optional(),
  previewCutoutUrl: zod.string().nullish().optional(),
  readyMadePreviewUrl: zod.string().nullish().optional(),
  previewAssetUrl: zod.string().nullish().optional(),
  previewColor: zod.string().nullish().optional(),
...
export const GetOrderResponse = zod.object({
  ...
  couponDiscountAmount: zod.number().optional(),
  paymentMethod: zod.enum(["cod", "transfer", "paid"]).optional(),
  governorate: zod.string().nullish(),
  area: zod.string().nullish(),
  address: zod.string().nullish(),
