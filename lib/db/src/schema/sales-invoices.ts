...
export const salesInvoicesTable = pgTable("sales_invoices", {
  ...
  // A client generated key makes a repeated POST return the original invoice
  // instead of creating a financially duplicated document.
  ...
  cancelledOriginalPaidAmount: numeric("cancelled_original_paid_amount", {
    precision: 14,
    scale: 2,
  }),
  cancelledOriginalRemainingAmount: numeric(
    "cancelled_original_remaining_amount",
    { precision: 14, scale: 2 },
  ),
  reversalReferences: jsonb("reversal_references")
