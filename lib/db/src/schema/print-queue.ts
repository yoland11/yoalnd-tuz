...
export const printersTable = pgTable("printers", {
  ...
  horizontalOffsetMm: numeric("horizontal_offset_mm", { precision: 3, scale: 1 }).notNull().default("0"),
  verticalOffsetMm: numeric("vertical_offset_mm", { precision: 3, scale: 1 }).notNull().default("0"),
