...
function TransactionDetailView({ data, isManager, busy, onReverse }: { data: TransactionDetail; isManager: boolean; busy: boolean; onReverse: (reason: string) => void }) {
  ...
  return <div className="space-y-4">
    ...
    {isReversalEntry && <div className="rounded-lg border border-amber-500/40 bg-amber-500/10 p-3 text-sm text-amber-600">هذه حركة عكسية (تصحيح){data.reversedTransactionId ? ` للحركة رقم ${data.reversedTransactionId}` : ""}.</div>}
