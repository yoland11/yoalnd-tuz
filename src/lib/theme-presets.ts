...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  {
    id: "visual-champagne-studio",
    name: "Champagne Studio",
    label: "Champagne Studio",
    colors: {
      background: "#F6EFE4",
      header: "#FFFAF1",
      footer: "#EADCC8",
  ...
  {
    id: "visual-emerald-ceremony",
    name: "Emerald Ceremony",
    label: "Emerald Ceremony",
    colors: {
      background: "#071D16",
      header: "#0A261D",
      footer: "#071D16",
  ...
  {
    id: "visual-pearl-commerce",
    name: "Pearl Commerce",
    label: "Pearl Commerce",
    colors: {
      background: "#F7F8F6",
      header: "#FFFFFF",
      footer: "#ECEAE3",
      sidebar: "#FFFFFF",
      primaryButton: "#C7A049",
      secondaryButton: "#ECEAE3",
      headings: "#171717",
      text: "#303235",
      cards: "#FFFFFF",
      links: "#9D792C",
  ...
  {
    id: "visual-burgundy-gallery",
    name: "Burgundy Gallery",
    label: "Burgundy Gallery",
    colors: {
      background: "#210910",
      header: "#2A0C15",
      footer: "#210910",
