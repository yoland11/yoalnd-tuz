...
const REPORTS: ReportConfig[] = [
  ...
  },
  {
    ...
    totals: [
      ...
      { key: "invoice_count", label: "عدد الفواتير", type: "number" },
      { key: "total_revenue", label: "إجمالي المبيعات", type: "money" },
      { key: "collected_amount", label: "المحصل", type: "money" },
      { key: "outstanding_amount", label: "المتبقي", type: "money" },
    ...
    columns: [
      ...
      { key: "collected_amount", label: "المحصل", type: "money", align: "center" },
      { key: "outstanding_amount", label: "المتبقي", type: "money", align: "center" },
      { key: "average_invoice", label: "متوسط الفاتورة", type: "money", align: "center" },
