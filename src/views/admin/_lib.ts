...
export const PERMISSION_LABELS: Record<Permission, string> = {
  "koshat_tasks.view": "عرض مهام الكوشات",
  "koshat_tasks.assign": "إسناد مهام الكوشات",
  "koshat_tasks.reassign": "إعادة إسناد مهام الكوشات",
  "koshat_tasks.accept": "قبول مهام الكوشات",
  "koshat_tasks.start": "بدء مهام الكوشات",
  "koshat_tasks.update_status": "تحديث حالة مهام الكوشات",
  "koshat_tasks.manage_members": "إدارة فريق مهام الكوشات",
  "koshat_tasks.checkout_assets": "إخراج أصول مهام الكوشات",
  "koshat_tasks.return_assets": "إعادة أصول مهام الكوشات",
  "koshat_tasks.report_damage": "الإبلاغ عن ضرر مهام الكوشات",
  "koshat_tasks.complete": "إكمال مهام الكوشات",
  "koshat_tasks.view_all": "عرض كل مهام الكوشات",
  ...
  "sales_invoice.permanent_delete": "الحذف النهائي لفاتورة مبيعات",
  ...
  booking_staff_assign: "تعيين فريق الحجز",
  ...
  booking_penalty_view: "عرض الغرامات والتلفيات",
  booking_penalty_create: "إضافة غرامة/تلفيات",
  booking_penalty_review: "مراجعة بلاغات التلف",
  booking_penalty_edit: "تعديل الغرامة",
  booking_penalty_pay: "تسديد الغرامة",
  booking_penalty_reverse: "عكس تسديد الغرامة",
  booking_penalty_report: "الإبلاغ عن تلف/فقدان",
  preparation_view: "عرض قائمة التجهيز",
  preparation_manage: "إدارة قائمة التجهيز",
  preparation_assign: "تعيين موظفي التجهيز",
  preparation_execute: "تنفيذ التجهيز (الكادر)",
