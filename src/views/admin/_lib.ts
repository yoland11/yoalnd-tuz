...
export const ALL_PERMISSIONS = [
  ...
  "koshas",
  "kosha_portal_view",
  "kosha_execution_view",
  "kosha_execution_edit",
  "kosha_details_manage",
  "sound_details_manage",
  "lighting_details_manage",
  "decor_details_manage",
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  kosha_portal_view: "عرض بوابة الكوشات والتنفيذ",
  kosha_execution_view: "عرض حجز التنفيذ",
  kosha_execution_edit: "تعديل حجز التنفيذ",
  kosha_details_manage: "إدارة تفاصيل الكوشة",
  sound_details_manage: "إدارة تفاصيل الصوتيات",
  lighting_details_manage: "إدارة تفاصيل الإضاءة",
  decor_details_manage: "إدارة الأثاث والديكور",
  execution_team_assign: "تعيين فريق التنفيذ",
  execution_photos_upload: "رفع صور التنفيذ",
  execution_checklist_manage: "إدارة قوائم فحص التنفيذ",
  kosha_assigned_view: "عرض حجوزات الكوشات المعيّنة",
  kosha_assigned_status_update: "تحديث حالة الحجز المعيّن",
  kosha_booking_qr_scan: "مسح QR الحجز",
  kosha_asset_qr_scan: "مسح QR الأصل",
  kosha_warehouse_issue_confirm: "تأكيد إخراج معدات المستودع",
  kosha_asset_return_confirm: "تأكيد إرجاع المعدات",
  kosha_task_complete: "إكمال مهام التنفيذ المعيّنة",
  kosha_damage_report: "الإبلاغ عن تلف أو نقص",
  kosha_execution_notes: "إضافة ملاحظات التنفيذ",
