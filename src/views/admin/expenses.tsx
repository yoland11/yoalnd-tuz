    ...
    <div className="space-y-5" dir="rtl">
      ...
      <div ref={reportRef} className="space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="bg-card rounded-xl border border-border/30 p-4"><p className="text-xs text-muted-foreground">عدد المصاريف</p><p className="text-lg font-bold text-foreground">{expenses.length.toLocaleString("ar-IQ-u-nu-latn")}</p></div>
