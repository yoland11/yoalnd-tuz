...
import {
  ...
  Bell, Bot, CircleDollarSign, Menu, PackageCheck, Search as SearchIconCompat, X, FileText, RefreshCw,
} from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { href: "/admin/approvals",      label: "مركز الموافقات",     icon: ShieldCheck,     perm: "tasks" },
  { href: "/admin/documents",      label: "مركز المستندات",     icon: ImageIcon,       perm: "orders" },
  { href: "/admin/live-operations",label: "العمليات المباشرة",  icon: Monitor,         perm: "dashboard" },
  { href: "/admin/smart-search",   label: "البحث الذكي",        icon: SearchIconCompat, perm: "dashboard" },
  { href: "/admin/timelines",      label: "التايملاين",         icon: Activity,        perm: "dashboard" },
  ...
  { href: "/admin/business-analytics", label: "تحليلات الأعمال", icon: BarChart3,      perm: "accounting" },
  { href: "/admin/warehouse-transfers", label: "تحويل المخازن",  icon: Boxes,          perm: "products" },
  { href: "/admin/assets",         label: "إهلاك الأصول",        icon: Package,        perm: "products" },
  { href: "/admin/maintenance-scheduler", label: "جدولة الصيانة", icon: AlertTriangle, perm: "products" },
  { href: "/admin/purchase-comparison", label: "مقارنة المشتريات", icon: ShoppingCart, perm: "accounting" },
  ...
  { href: "/admin/sync-center",   label: "مركز المزامنة",     icon: RefreshCw,       perm: "settings", adminOnly: true },
